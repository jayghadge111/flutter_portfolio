...
// Method to download file from assets in web
  Future<void> downloadFileFromAssets() async {
    try {
      // Load file from assets
      final bytes = await rootBundle.load('images/jayesh_ghadge_resume.pdf');
      ...
      final anchor = html.AnchorElement()
        ..href = url
        ..style.display = 'none'
        ..download = 'jayesh_ghadge_resume.pdf';
                          ...
                          child: Container(
                            ...
                            child: TextButton(
                              onPressed: () {
                                ...
                                // method.launchURL(
                                //     "https://drive.google.com/file/d/14u-xTMeFgB6vp7D-KbylwBQm70WQ8ymZ/view?usp=sharing");
                              },
                              child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        IconButton(
                            ...
                            onPressed: () {
                              method
                                  .launchURL("https://github.com/jayghadge111");
                            }),
                        // IconButton(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    children: [
                                      Text(
                                        "I'm a freelancer based in Pune, IN specializing in \nbuilding (and occasionally designing) exceptional websites, \napplications, and everything in between.",
                                        style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 16.0,
                                          letterSpacing: 2.75,
