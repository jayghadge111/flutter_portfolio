...
import 'package:jayesh_flutter/src/widgets/mobile_work.dart';
          ...
          child: Column(
            children: [
              UserAccountsDrawerHeader(
                  ...
                  accountName: Text("Jayesh Ghadge"),
                  accountEmail: Text("jayghadge111@gmail.com")),
              ListTile(
                title: Text("Share"),
            ...
            children: [
              ...
              Padding(
                ...
                child: Wrap(
                  children: [
                    Text(
                      "I'm a freelancer based in Pune, IN specializing in building (and occasionally designing) exceptional websites, applications, and everything in between.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 15.0,
                        letterSpacing: 2.75,
